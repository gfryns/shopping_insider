...
AS (
  SELECT
    ...
    COUNT(DISTINCT IF(is_approved = 1, unique_offer_id, NULL)) AS total_approved_offers,
    COUNT(DISTINCT IF(funnel_in_stock = 1, unique_product_id, NULL)) AS total_in_stock,
    COUNT(DISTINCT IF(funnel_in_stock = 1, unique_offer_id, NULL)) AS total_in_stock_offers,
    COUNT(DISTINCT IF(funnel_targeted = 1, unique_product_id, NULL)) AS total_targeted,
    COUNT(DISTINCT IF(funnel_targeted = 1, unique_offer_id, NULL)) AS total_targeted_offers,
    ...
    COUNT(DISTINCT IF(funnel_has_impression = 1, unique_offer_id, NULL))
      AS total_offers_with_impressions_in_30_days,
    ...
    COUNT(DISTINCT IF(funnel_has_clicks = 1, unique_offer_id, NULL))
      AS total_offers_with_clicks_in_30_days,
